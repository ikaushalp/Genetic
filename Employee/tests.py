...
class EmployeeCase():
    def admincase(self):
        ...
        Employee.objects.create(name='Hardy Champlin', gender='Male', blood_group='AB-', birthdate='1998-05-12',
                                mobile_no="+917445600845", email='admin@genetic.com', marital_status='Married',
                                address='Golden Height,Andheri(West)', role=1, designation='Admin',
                                joining_date=current_date)

        add = CustomUser.objects.create_user(username='admin', password='admin@123', email='admin@genetic.com', role=1,
                                             aid=2)
        add.save()
